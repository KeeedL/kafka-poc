...
public class TransferMoneyDtoRequest implements Serializable {
    ...
    public TransferMoneyDtoRequest(String sourceAccountUuid, String targetAccountUuid, float amountToTransfer) {
        this.sourceAccountUuid = sourceAccountUuid;
        this.targetAccountUuid = targetAccountUuid;
        this.amountToTransfer = amountToTransfer;
    }

    public TransferMoneyDtoRequest() {
    }
    ...
    public boolean equals(Object o) {
        ...
        TransferMoneyDtoRequest that = (TransferMoneyDtoRequest) o;
